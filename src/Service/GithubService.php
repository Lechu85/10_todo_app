...
//info use Symfony\Component\HttpClient\HttpClient;
...
class GithubService
{
	...
	public function getHealthReport(string $dinosaurName): HealthStatus
    {
		...
		//info $client = HttpClient::create(); teraz używamy interfejsu
		...
		$this->logger->info('Request Dino Issue for the message.',[
			'dino' =>  $dinosaurName,
